...
#' @param components Indices of the principal components whose names will be
#'   returned. If NULL, all PC names will be returned.
#'
#' @details Return the principal component labels for an object of class 'pca'.
#'
