...
```{r ex4, fig.height = 7, fig.width = 9, fig.cap = 'Basic loadings plot.'}
...
```{r ex5, fig.height = 5, fig.width = 9, fig.cap = 'Basic eigencor plot.'}
...
```{r ex7, fig.height = 7, fig.width = 9, fig.cap = 'Advanced bi-plot I.'}
...
```{r ex8, fig.height = 8, fig.width = 8, fig.cap = 'Advanced bi-plot II.'}
...
```{r ex9, fig.height = 8, fig.width = 8, fig.cap = 'Advanced bi-plot III.'}
...
```{r ex10, fig.height = 7, fig.width = 9, fig.cap = 'Advanced bi-plot IV.'}
...
```{r ex11, fig.height = 7, fig.width = 9, fig.cap = 'Advanced bi-plot V.'}
...
```{r ex12, fig.height = 9, fig.width = 8, fig.cap = 'Advanced pairs plot I.'}
...
```{r ex13, fig.height = 8, fig.width = 12, fig.cap = 'Advanced pairs plot II.'}
...
```{r ex14, fig.height = 7, fig.width = 10, fig.cap = 'Advanced plotloadings I'}
...
```{r ex15, fig.height = 9, fig.width = 11, fig.cap = 'Advanced plotloadings II'}
...
```{r ex17, fig.height = 5, fig.width = 12, fig.cap = 'Advanced eigencorplot I.'}
...
```{r ex18, fig.height = 10, fig.width = 15, fig.cap = 'Plot multiple plots on the same page.'}
