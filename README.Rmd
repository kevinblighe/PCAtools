...
```{r ex4, fig.height = 7, fig.width = 9, fig.cap = 'Figure 4: Plot the component loadings and label genes most responsible for variation'}
...
```{r ex5, fig.height = 5, fig.width = 9, fig.cap = 'Figure 5: Correlate PCs to metadata variables'}
...
```{r ex7, fig.height = 7, fig.width = 9, fig.cap = 'Figure 7: adding lines and a legend to a bi-plot'}
...
```{r ex8, fig.height = 8, fig.width = 8, fig.cap = 'Figure 8: supplying custom colours to a bi-plot'}
...
```{r ex9, fig.height = 8, fig.width = 8, fig.cap = 'Figure 9: supplying custom colours and shapes to a bi-plot, removing connectors, and modifying titles'}
...
```{r ex10, fig.height = 7, fig.width = 9, fig.cap = 'Figure 10: removing labels, modifying line types, removing gridlines, and increasing point size in a bi-plot'}
...
```{r ex11, fig.height = 7, fig.width = 9, fig.cap = 'Figure 11: colouring by a continuous variable and plotting other PCs in a bi-plot'}
...
```{r ex12, fig.height = 9, fig.width = 8, fig.cap = 'Figure 12: Maximising available space in a pairs plot'}
...
```{r ex13, fig.height = 8, fig.width = 12, fig.cap = 'Figure 13: arranging a pairs plot horizontally'}
...
```{r ex14, fig.height = 7, fig.width = 10, fig.cap = 'Figure 14: modifying cut-off for labeling in a loadings plot'}
...
```{r ex17, fig.height = 5, fig.width = 12, fig.cap = 'Figure 17: modifying cut-offs and symbols for statistical significance in eigencorplot'}
...
```{r ex18, fig.height = 10, fig.width = 15, fig.cap = 'Figure 18: a merged panel of all PCAtools plots'}
