...
```{r ex2b, fig.height = 7, fig.width = 7, fig.cap = 'Figure 2b: A bi-plot'}
...
```{r ex3b, fig.height = 6, fig.width = 7, fig.cap = 'Figure 2b: A bi-plot'}
...
```{r ex4, message = FALSE, fig.height = 10, fig.width = 10, fig.cap = 'Figure 3: A pairs plot'}
...
```{r ex5, fig.height = 6, fig.width = 8, fig.cap = 'Figure 4: A loadings plot'}
...
```{r ex6, warning = FALSE, fig.height = 4, fig.width = 8, fig.cap = 'Figure 5: An eigencor plot'}
...
```{r ex7, fig.height = 7, fig.width = 9, fig.cap = 'Figure 6: Advanced scree plot illustrating optimum number of PCs'}
...
```{r ex8, fig.height = 7, fig.width = 7.5, fig.cap = 'Figure 7: Colour by a metadata factor, use a custom label, add lines through origin, and add legend'}
...
```{r ex9, message = FALSE, fig.height = 7.5, fig.width = 7, fig.cap = 'Figure 8: Supply custom colours and encircle variables by group'}
...
```{r ex10, message = FALSE, fig.height = 7.5, fig.width = 7, fig.cap = 'Figure 9: Stat ellipses'}
...
```{r ex12b, message = FALSE, fig.height = 5.5, fig.width = 11, fig.cap = 'Figure 11b: Modify line types, remove gridlines, and increase point size'}
...
```{r ex13a, fig.height = 5.5, fig.width = 6, fig.cap = 'Figure 12a: Colour by a continuous variable and plot other PCs'}
...
```{r ex17, fig.height = 7, fig.width = 9, fig.cap = 'Figure 16: plotting absolute component loadings'}
...
```{r ex18a, warning = FALSE, fig.height = 4.25, fig.width = 12, fig.cap = 'Figure 17a: Correlate the principal components back to the clinical data'}
...
```{r ex18b, warning = FALSE, fig.height = 5, fig.width = 12, fig.cap = 'Figure 17b: Correlate the principal components back to the clinical data'}
...
```{r ex19, message = FALSE, warning = FALSE, fig.height = 10, fig.width = 15, fig.cap = 'Figure 18: a merged panel of all PCAtools plots'}
