...
```{r ex1, fig.height = 7, fig.width = 16, fig.cap = 'Basic SCREE plot.'}
...
```{r ex2, fig.height = 7, fig.width = 8, fig.cap = 'Basic bi-plot.'}
...
```{r ex3, fig.height = 10, fig.width = 10, fig.cap = 'Basic pairs plot.'}
...
```{r ex4, fig.height = 6, fig.width = 8, fig.cap = 'Basic loadings plot.'}
...
```{r ex5, fig.height = 4, fig.width = 8, fig.cap = 'Basic eigencor plot.'}
...
```{r ex6, fig.height = 7, fig.width = 10, fig.cap = 'Advanced SCREE.'}
...
```{r ex7, fig.height = 6, fig.width = 8, fig.cap = 'Advanced bi-plot I.'}
...
```{r ex8, eval = FALSE, fig.height = 7, fig.width = 7, fig.cap = 'Advanced bi-plot II.'}
...
```{r ex9, fig.height = 7, fig.width = 7, fig.cap = 'Advanced bi-plot III.'}
...
```{r ex10, fig.height = 6, fig.width = 8, fig.cap = 'Advanced bi-plot IV.'}
...
```{r ex11, eval = FALSE, fig.height = 6, fig.width = 8, fig.cap = 'Advanced bi-plot V.'}
...
those who love exploring data and squeexing every last ounce of information of
...
```{r ex12, eval = FALSE, fig.height = 8, fig.width = 7, fig.cap = 'Advanced pairs plot I.'}
...
```{r ex13, eval = FALSE, fig.height = 6, fig.width = 9, fig.cap = 'Advanced pairs plot II.'}
...
```{r ex14, fig.height = 6, fig.width = 9, fig.cap = 'Advanced plotloadings I'}
...
```{r ex15, eval = FALSE, fig.height = 9, fig.width = 11, fig.cap = 'Advanced plotloadings II'}
...
This is also and mostly untapped resource in the era of 'big data' and can
help to guide an analysis down a particular path (or not!).
...
```{r ex16, fig.height = 4, fig.width = 12, fig.cap = 'Advanced eigencorplot I.'}
...
```{r ex17, eval = FALSE, fig.height = 5, fig.width = 12, fig.cap = 'Advanced eigencorplot I.'}
...
with highly sttatistically significant correlation (p<0.0001) to ER status,
...
```{r ex18, eval = FALSE, fig.height = 10, fig.width = 15, fig.cap = 'Plot multiple plots on the same page.'}
